...
\begin{theorem} \label{thm:0-times-vec}
    $\forall v \in V, \quad 0v = 0.$ \footnote{See \ref{lean:0-times-vec} for the formalized proof.}
\end{theorem}
...
\begin{exercise}\label{ex:double-negation}
    Prove that $-(-v) = v$ for every $v \in V$. \footnote{See \ref{lean:double-negation} for the formalized proof.}
\end{exercise}
...
\begin{exercise} \label{ex:add-inv-swap-0-times-vec} 
    ...
    \[
        \forall v \in V,\quad 0v = 0. \footnote{See \ref{lean:add-inv-swap-0-times-vec} for the formalized proof.}
    \]
\end{exercise}
...
\begin{leanbox}{Double Negation (\ref{ex:add-inv-swap-0-times-vec})} \label{lean:add-inv-swap-0-times-vec}
\begin{minted}{lean4}

\end{minted}
\href{}{Open in Lean playground}
\end{leanbox}
